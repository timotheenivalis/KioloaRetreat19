...
\begin{tikzpicture} 
    \node (me) at (0,0) {\includegraphics[height=0.8\textheight]{Figures/birding}};
    
    \node[anchor=west] (ld) at (3.5,2) {\includegraphics[height=0.3\textheight]{Figures/ld}}; 
        \node[anchor=west] (skull) at (3,-2) {\includegraphics[height=0.3\textheight]{Figures/skull}};
    \node[anchor=west] (colub) at (5,0) {\includegraphics[height=0.25\textheight]{Figures/colub}};
    \node[anchor=west] (ol) at (6,-2.5) {\includegraphics[height=0.3\textheight]{Figures/ol}};
    \node[anchor=west] (cb) at (-0.3,-1.5) {\includegraphics[height=0.3\textheight]{Figures/catb}};
